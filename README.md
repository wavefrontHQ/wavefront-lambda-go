...
Please refer to the [code sample](https://github.com/wavefrontHQ/wavefront-lambda-go/blob/master/example.py) which shows how you can send custom business metrics to wavefront from your lambda function.
